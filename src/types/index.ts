...
export type View = 'DASHBOARD' | 'TERMINAL' | 'BUILDER' | 'INTELLIGENCE' | 'ASSISTANT' | 'PORTFOLIO' | 'PROFILE';
export type BotStrategy = 'SENTIMENT' | 'TECHNICAL_V2' | 'NEBULA_V5' | 'NEBULA_V6' | 'CUSTOM_AI' | 'HEDGING_BOT' | 'HFT_BOT' | 'AI_INTELLIGENCE';
...
export interface BotState {
  ...
  // Subscription tracking — server-owned; access is derived from subscriptionEndsAt.
  subscriptionPlan?: string | null;
  subscriptionBillingCycle?: 'WEEKLY' | 'MONTHLY' | '6MONTHS' | 'YEARLY' | null;
