...
const TerminalView: React.FC<TerminalViewProps> = (props) => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex flex-col bg-[#0b0c10] select-none overflow-y-auto custom-scrollbar pb-10">
      {/* Top Bar */}
      <header className="h-12 border-b border-white/5 flex items-center justify-between px-4 bg-[#121418] sticky top-0 z-[90] shrink-0">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-[1fr_320px] relative">
        ...
        <aside className={`fixed inset-y-0 lg:inset-y-auto lg:sticky lg:top-12 right-0 w-[320px] lg:h-[calc(100vh-8rem)] z-[200] lg:z-[60] transform lg:translate-x-0 transition-transform duration-300 border-l border-white/5 bg-[#121418] flex flex-col shadow-2xl ${isOrderOpen ? 'translate-x-0' : 'translate-x-full lg:translate-x-0'}`}>
